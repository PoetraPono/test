				    ...
				    <div class="search-box">
					    <div id="sb-search" class="sb-search">
							...
							<?php
								...
								if(isset($cari)){
									if($input != ""){
									$query = $mysqli->query("SELECT tb_berita.baca, tb_berita.id_berita, tb_category.nama_category, tb_category.id_category, tb_berita.judul,DATE_FORMAT(tb_berita.tgl, '%d-%m-%Y') as tgl, SUBSTRING(tb_berita.isi, 5,100) as isi, tb_berita.image FROM tb_berita LEFT JOIN tb_category ON tb_berita.id_category = tb_category.id_category WHERE tb_berita.judul LIKE '%$input%' ORDER BY tb_berita.id_berita DESC");
									}
								}
							?>
						</div>
