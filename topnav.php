	<div class="header">
		<div class="header-bottom">
			<div class="logo text-center">
				<a href="index"><img src="media/Capture2.jpg" alt="rekalpa.com" /></a>
			</div>
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav">
				    ...
				    <li class="dropdown">
						...
						?>
							<li><a href="category.php?id_category=<?php echo $data['id_category']?>"><?php echo $data['nama_category']?></a></li>
							<li class="divider"></li>
						<?php }?>
						</ul>
					</li>
