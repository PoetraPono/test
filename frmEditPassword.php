          ...
          <div class="row">
			...
			<div class="col-md-9">
              <div class="nav-tabs-custom">
				...
				<?php
					$sql = mysqli_query($mysqli, "SELECT id_wartawan, password FROM tb_wartawan WHERE id_wartawan = '$id_wartawan'");
					$row = $sql->fetch_assoc();
				?>
                    <form class="form-horizontal" action="model/editPasswordWartawan.php" enctype="multipart/form-data" method="post">
                      <div class="form-group">
                        <label for="inputName" class="col-sm-2 control-label">Old Password</label>
                        <div class="col-sm-10">
                          <input type="password" name="passwordxx" class="form-control" id="inputName" placeholder="Name" value="<?php echo $row['password']?>">
