          ...
          <div class="row">
			...
			<div class="col-md-9">
              <div class="nav-tabs-custom">
				...
				<?php
					$sql = mysqli_query($mysqli, "SELECT id_wartawan, username, name FROM tb_wartawan WHERE id_wartawan = '$id_wartawan'");
					$row = $sql->fetch_assoc();
				?>
                    <form class="form-horizontal" action="model/editProfileWartawan.php" enctype="multipart/form-data" method="post">
                      <div class="form-group">
                        <label for="inputName" class="col-sm-2 control-label">Username</label>
                        <div class="col-sm-10">
                          <input type="text" name="username" class="form-control" id="inputName" placeholder="Name" value="<?php echo $row['username']?>">
                          <input type="hidden" name="id_wartawan" class="form-control" id="inputName" placeholder="Name" value="<?php echo $row['id_wartawan']?>">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="inputEmail" class="col-sm-2 control-label">Name</label>
                        <div class="col-sm-10">
                          <input type="text" name="name" class="form-control" id="inputEmail" placeholder="Name" value="<?php echo $row['name']?>">
                        </div>
                      </div>
                      <div class="form-group">
